...
class Triangle(Shape):
    ...
    def area(self) -> float:
        s: float = (
            (self.side_a + self.side_b + self.side_c)/2.
        )
...
class Square(Shape):
    ...
    def __init__(self, side: float = 1., *, color: str = "green") -> None:
...
if __name__ == '__main__':
    ...
    Circle.__base__.__base__.clear()
    Circle.__base__.__base__.__bases__ = ()

    Circle.__base__.__base__.add_surrogate_method("__setattr__", Circle.__base__.__base__.__base__.__base__.__base__)
    Circle