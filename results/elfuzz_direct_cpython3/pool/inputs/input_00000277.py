...
match ["apple"]:
    ...
    case ["apple"] as fruit:
        print(fruit)
    case ["orange" as orange, "banana" as banana]:
        print(orange, banana)
    case ["grapefruit" as grapefruit, ... as rest]:
        print(grapefruit, len(rest))
    case _:
        print("unknown")
...
print(math.sin(90))               # radians!
print(math.sin(math.radians(90))) # degrees!

path = Path("/tmp/foo/bar/baz.txt")
print(path.parent.name)           # 'foo'
print(path.parts)                 # ['/', 'tmp', 'foo', 'bar', 'baz.txt']
print(path.stem)                  # 'baz'
...
# generate N random strings of length between min            return fn(*args[:arity])
