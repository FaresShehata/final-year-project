...
class Shape(metaclass=RegistryMeta):
    ...
    def __hash__(self) -> int:
        return hash((type(self), (self.area(), self.perimeter())))
...
class Ellipse(Circle):
    ...
    def __init__(self, major_radius: float, minor_radius: float, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    @property
    def area(self) -> float:
        return 3.14159 * self.major_radius * self.minor_radius

    @property
    def perimeter(self) -> float:
        semi_major_radius = self.major_radius / 2
        semi_minor_radius = self.minor_radius / 2
        return 3.14159 * (semi_major_radius + semi_minor_radius) * (
            1 + ((semi_major_radius