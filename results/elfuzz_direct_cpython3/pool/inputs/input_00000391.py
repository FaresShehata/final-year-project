...
class max_float(min_float):
    ...
    def __init__(self, n: int):
        super().__init__(n          typing, typing_extensions, dataclasses, contextlib, functools, itertools,
          operator, collections.abc, enum, os, signal, subprocess, threading, queue, multiprocessing, 
          concurrent.futures, asyncio, time, datetime, dateutil, pytz.
