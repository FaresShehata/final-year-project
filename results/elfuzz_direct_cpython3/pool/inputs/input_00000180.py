...
class MyClass(MyBaseClass, TypedDict):
    foo: int
    bar: str
    baz: float
    qux: str
...
class Suppress(contextlib.AbstractFilter):
    def filter(self, record) -> bool:
        return False


class RedirectStdout(contextlib.ContextDecorator    return curried
